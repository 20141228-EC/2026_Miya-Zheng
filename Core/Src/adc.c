...
void HAL_ADC_MspInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  */
    ...
    PB2     ------> ADC2_IN12
    */
    GPIO_InitStruct.Pin = CAP_I_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(CAP_I_GPIO_Port, &GPIO_InitStruct);
  ...
  */
    ...
    PB12     ------> ADC4_IN3
    */
    GPIO_InitStruct.Pin = BAT_I_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(BAT_I_GPIO_Port, &GPIO_InitStruct);
  ...
  */
    ...
    PA8     ------> ADC5_IN1
    */
    GPIO_InitStruct.Pin = CHAS_I_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(CHAS_I_GPIO_Port, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA0     ------> ADC1_IN1
    */
    HAL_GPIO_DeInit(BAT_V_GPIO_Port, BAT_V_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PB2     ------> ADC2_IN12
    */
    HAL_GPIO_DeInit(CAP_I_GPIO_Port, CAP_I_Pin);
  ...
  /* USER CODE END ADC4_MspDeInit 0 */
    ...
    PB12     ------> ADC4_IN3
    */
    HAL_GPIO_DeInit(BAT_I_GPIO_Port, BAT_I_Pin);
  ...
  /* USER CODE END ADC5_MspDeInit 0 */
    ...
    PA8     ------> ADC5_IN1
    */
    HAL_GPIO_DeInit(CHAS_I_GPIO_Port, CHAS_I_Pin);
